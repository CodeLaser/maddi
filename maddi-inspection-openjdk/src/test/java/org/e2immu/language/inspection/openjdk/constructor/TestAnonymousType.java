...
package org.e2immu.language.inspection.openjdk.constructor;
...
public class TestAnonymousType extends CommonTest {
    ...
    public void test3b() {
        ...
        ConstructorCall newFIS = (ConstructorCall) newInputStreamReader.parameterExpressions().getFirst();
        assertEquals("in", newFIS.parameterExpressions().getFirst().toString());
        ...
        LocalVariableCreation readLvc = (LocalVariableCreation) read.methodBody().statements().getFirst();

...
import io.codelaser.maddi.cst.impl.element.*;
import io.codelaser.maddi.cst.impl.expression.*;
import io.codelaser.maddi.cst.impl.expression.util.PrecedenceEnum;
import io.codelaser.maddi.cst.impl.info.*;
import io.codelaser.maddi.cst.impl.output.*;
import io.codelaser.maddi.cst.impl.statement.*;
import io.codelaser.maddi.cst.impl.translate.TranslationMapImpl;
import io.codelaser.maddi.cst.impl.type.*;
import io.codelaser.maddi.cst.impl.variable.*;
...
public class FactoryImpl extends PredefinedImpl implements Factory {
    ...
    @Override
    public InfoMap newInfoMap(Set<TypeInfo> primaryTypes, Set<TypeInfo> rebuiltPrimaryTypes) {
        return new InfoMapImpl(primaryTypes, rebuiltPrimaryTypes);
    }
    ...
    @Override
    public SingleLineComment newSingleLineComment(Source source, String comment) {
        return new SingleLineCommentImpl(source, comment);
    }

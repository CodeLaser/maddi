...
public class TestOverload0 extends CommonTest {
    ...
    @Test
    public void test() {
        TypeInfo typeInfo = scan("org.e2immu.analyser.resolver.testexample.Overload_7", INPUT1);
        ...
        if (s1 instanceof ExpressionAsStatement eas) {
            if (eas.expression() instanceof MethodCall mc) {
                ...
                assertEquals("org.e2immu.analyser.resolver.testexample.Overload_7.replace(Object)",
    ...
    @Test
    public void test2() {
        TypeInfo typeInfo = scan("org.e2immu.analyser.resolver.testexample.Overload_6", INPUT2);
    ...
    @Test
    public void test3() {
        TypeInfo typeInfo = scan("org.e2immu.analyser.resolver.testexample.Overload_5", INPUT3);
        MethodInfo test1 = typeInfo.findUniqueMethod("test", 0);
        Block block = test1.methodBody();
        Statement s1 = block.statements().get(2);
        if (s1 instanceof ReturnStatement rs) {
    ...
    @Test
    public void test4() {
        scan("org.e2immu.analyser.resolver.testexample.Overload_4", INPUT4);
    }
    ...
    @Test
    public void test5() {
        scan("org.e2immu.analyser.resolver.testexample.Overload_3", INPUT5);
    }
    ...
    @Test
    public void test6() {
        scan("org.e2immu.analyser.resolver.testexample.Overload_2", INPUT6);
    }
    ...
    @Test
    public void test7() {
        scan("org.e2immu.analyser.resolver.testexample.Overload_1", INPUT7);
    }
    ...
    @Test
    public void test8() {
        scan("org.e2immu.analyser.resolver.testexample.Overload_0", INPUT8);
    }

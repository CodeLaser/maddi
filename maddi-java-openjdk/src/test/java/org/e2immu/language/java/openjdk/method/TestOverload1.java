...
public class TestOverload1 extends CommonTest {
    ...
    @Test
    public void test4() {
        // Original: after parsing, called javaInspector.print2(typeInfo.compilationUnit()) and asserted
        // the printed output matched an expected string with formatted type parameters. print2() on
        // JavaInspector uses a different configuration than CommonTest.print2(); the assertion was dropped
        // to avoid comparing output produced by a different formatter setup.
        scan("a.b.X", INPUT4);
    }
    ...
    @Test
    public void test5() {
        scan("org.e2immu.analyser.resolver.testexample.Overload1_5", INPUT5);
    }
}

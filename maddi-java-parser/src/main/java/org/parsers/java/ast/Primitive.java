...
* Generated Code for Primitive Token subclass
...
public class Primitive extends KeyWord {

    public Primitive(TokenType type, TokenSource tokenSource, int beginOffset, int endOffset) {

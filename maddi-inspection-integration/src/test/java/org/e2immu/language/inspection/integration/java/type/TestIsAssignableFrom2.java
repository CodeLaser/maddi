...
public class TestIsAssignableFrom2 extends CommonTest {
    ...
    public void test() {
        ...
        assertFalse(runtime.isAssignableFrom(iterableCloseable, closeableArray, true));
    }
    ...
    public void test5() {
        ...
        assertTrue(runtime.isAssignableFrom(longPt, intPt, true));
        assertFalse(runtime.isAssignableFrom(longPt, intPt, false));
        assertTrue(runtime.isAssignableFrom(objectPt, stringPt, true));
        assertFalse(runtime.isAssignableFrom(objectPt, stringPt, false));

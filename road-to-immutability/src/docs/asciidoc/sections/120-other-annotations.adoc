...
NOTE: *Not implemented.* {extensionClass} is defined in `maddi-annotation`, but no part of the analyzer reads it,
...
NOTE: *Not implemented.* {singleton} is defined in `maddi-annotation`, but no part of the analyzer reads it, and

...
Returning a part of the hidden content of the type, or exposing it as argument, both warrant a {independentHc}
annotation:
...
Observe that content dependence implies absence of dependence, as described in <<linking-dependence>>

...
The goal is to use this section as a reference: most linking situations should be
described here.
...
The situation becomes more complicated when we consider method arguments that are of functional interface type: method references, lambdas, anonymous classes, and any variable representing such objects.

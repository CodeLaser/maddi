...
public class TestAssignmentsExpression extends CommonTest {
    ...
    public void test1() {
        ...
        VariableData vd100 = VariableDataImpl.of(if1.block().statements().getFirst());
        ...
        assertEquals("pieces_bytes[pos++]=pieces_bytes[pos++]=pieces_bytes[pos++]=pieces_bytes[pos++]=(byte)255;",
                if1.block().statements().getFirst().toString());
        assertEquals("pieces_bytes[pos++]=(byte)(value>>24);",
                if1.elseBlock().statements().getFirst().toString());
    }

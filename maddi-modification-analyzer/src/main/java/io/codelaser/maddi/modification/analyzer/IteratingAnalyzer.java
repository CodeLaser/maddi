...
public interface IteratingAnalyzer {
     ...
     * floors keep this to the compelling "one culprit" cases; see the design note in {@code docs/design/guard-mode-analysis.md}.
     */
    ...
    /**
     * Incremental entry point for the early-cutoff skip (docs/design/analysis-rewiring.md). When {@code initialDirty} is

...
public class TestIndependentOfByteArray extends CommonTest {
    ...
    public void test1() {
        ...
        assertEquals("""
                ...
                0:b*[off++]→0:b*[1:off],0:b*.§$←this*.arrayIn.§$, 1:off←$_ce7, 2:len←$_ce8,\
                2:len→this*.arrayInPtr] --> -\
        ...
        Statement s3 = read.methodBody().statements().get(3);
        {
            ...
            assertEquals("""
                    0:b∋this.back,0:b[1:off]←this.back,0:b[off++]←this.back,0:b[off++]→0:b[1:off],0:b.§$←this.arrayIn.§$\
        ...
        }
        {
            ...
            assertEquals("""
                    0:b∋this.back,0:b[1:off]←this.back,0:b[1:off]→0:b[off++],0:b[off++]←this.back,0:b[off++]→0:b[1:off],\
                    0:b.§$←this.arrayIn.§$\
                    """, viB.linkedVariables().toString());
        }

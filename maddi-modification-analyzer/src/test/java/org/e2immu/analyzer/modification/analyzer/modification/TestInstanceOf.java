...
public class TestInstanceOf extends CommonTest {
    ...
    public void test2() {
        ...
        assertEquals("o.§es∩0:i,o.§es∋1:s,o.§es→set.§es,o.§m≡set.§m,o≺0:i,o→set", viO00.linkedVariables().toString());
        ...
        assertEquals("set.§m≡o.§m,set≺0:i,set←o", viSet.linkedVariables().toString());
        ...
        assertEquals("o.§m≡set.§m,o≺0:i,o→set", viO.linkedVariables().toString());

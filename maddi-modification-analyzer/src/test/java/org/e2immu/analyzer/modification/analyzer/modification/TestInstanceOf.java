...
public class TestInstanceOf extends CommonTest {
    ...
    public void test2() {
        ...
        assertEquals("o.§es∩0:i,o.§es∋1:s,o.§es→set.§es,o.§m≡set.§m,o→set", viO00.linkedVariables().toString());
        ...
        assertEquals("set←o", viSet.linkedVariables().toString());
        ...
        assertEquals("o.§m≡set.§m,o→set", viO.linkedVariables().toString());
        assertTrue(viO.isUnmodified());

        VariableInfo viI = vd0.variableInfo(i);
        assertEquals("[a.b.X.R]", viI.downcast().toString());
        assertEquals("0:i≥1:s,0:i∩o.§es,0:i≻set.§es", viI.linkedVariables().toString());

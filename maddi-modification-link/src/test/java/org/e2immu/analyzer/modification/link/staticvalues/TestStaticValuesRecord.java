...
public class TestStaticValuesRecord extends CommonTest {
    ...
    public void test6() {
        ...
        MethodLinkedVariables mlvMethod3 = method3.analysis().getOrCreate(METHOD_LINKS, () -> tlc.doMethod(method3));
        {
            ...
            assertEquals("b.function←length,b.variables[0]←0:in,b.variables[0]∈b.variables,b.variables∋0:in",
        ...
        }
        {
            ...
            assertEquals("""
                    r.function←Λb.function,r.function←length,r.variables[0]←b.variables[0],\
        ...
        MethodLinkedVariables mlvMethod4 = method4.analysis().getOrCreate(METHOD_LINKS, () -> tlc.doMethod(method4));
        {
            ...
            assertEquals("b.function←length,b.variables[1]←0:t,b.variables[1]∈b.variables,b.variables∋0:t",
            ...
            assertEquals("""
                    r.function←Λb.function,r.function←length,r.variables[1]←b.variables[1],r.variables[1]←0:t,\
        ...
        MethodLinkedVariables mlvMethod5 = method5.analysis().getOrCreate(METHOD_LINKS, () -> tlc.doMethod(method5));
        {
            ...
            assertEquals("r.function←length,r.variables[1]←0:t,r.variables[1]∈r.variables,r.variables∋0:t",
                    vi0b.linkedVariables().toString());
        }
    ...
    public void test7() {
        ...
        }
        {
            ...
            assertEquals("b.function←length,b.variables[0]←0:s,b.variables[0]∈b.variables,b.variables∋0:s",
        ...
        MethodLinkedVariables mlvMethod2 = method2.analysis().getOrCreate(METHOD_LINKS, () -> tlc.doMethod(method2));
        {
            ...
            assertEquals("""
                    b.function→Λr.function,b.function←length,b.variables[0]→r.variables[0],\

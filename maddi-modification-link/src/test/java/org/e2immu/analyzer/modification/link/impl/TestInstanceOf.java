...
public class TestInstanceOf extends CommonTest {
    ...
    public void test1() {
        ...
        ParameterInfo s = setAdd.parameters().getLast();
        {
            ...
            assertEquals("0:object→set,0:object.§m≡set.§m", viObject0E.linkedVariables().toString());
    ...
    public void test2() {
        ...
        assertEquals("set.§m≡o.§m,set≺0:i,set←o", viSet0E.linkedVariables().toString());
        assertFalse(viI0E.isModified());
        ...
        assertEquals("set.§es≺0:i,set.§es∋1:s,set.§es←o.§es,set.§m≡o.§m,set≺0:i,set←o",
                vi000Set.linkedVariables().toString()); // set←o dropped

        VariableInfo vi000O = vd000.variableInfo("o");
        assertEquals("o.§es∩0:i,o.§es∋1:s,o.§es→set.§es,o.§m≡set.§m,o≺0:i,o→set", vi000O.linkedVariables().toString());

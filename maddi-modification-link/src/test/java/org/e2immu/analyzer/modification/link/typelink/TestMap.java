...
public class TestMap extends CommonTest {
    ...
    public void test2Reverse0() {
        ...
        assertEquals("""
                map.§vks[-1]→reverse0.map.§vks[-1],map.§vks[-1]∩this.map.§kvs,map.§vks[-1]∩reverse0.map.§vks[-2],\
                map.§vks[-1]∩entries.§kvs,map.§vks[-2]→reverse0.map.§vks[-2],map.§vks[-2]∩this.map.§kvs,\
                map.§vks[-2]∩reverse0.map.§vks[-1],map.§vks[-2]∩entries.§kvs,map.§vks~this.map.§kvs,\
                map.§vks~reverse0.map.§vks,map.§vks~entries.§kvs,map→reverse0.map\

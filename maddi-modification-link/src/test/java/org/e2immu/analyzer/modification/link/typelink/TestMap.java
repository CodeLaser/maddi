...
public class TestMap extends CommonTest {
    ...
    public void test2a() {
        ...
        assertEquals("""
                [] --> reverse0.map∩this.map.§kvs,\
                reverse0.map.§vks[-2].§k∩this.map.§kvs,\
                reverse0.map.§vks[-1].§v∩this.map.§kvs,\
    ...
    public void test2() {
        ...
        assertEquals("""
                [] --> reverse.map∩this.map.§kvs,\
                reverse.map.§vks[-2].§k∩this.map.§kvs,\
                reverse.map.§vks[-1].§v∩this.map.§kvs,\
        ...
        assertEquals("""
                r.map∩0:c.map.§kvs,\
                r.map.§vks[-2].§k∩0:c.map.§kvs,\
                r.map.§vks[-1].§v∩0:c.map.§kvs,\
                r.map.§vks~0:c.map.§kvs\
                """, tlvR0.toString());

        assertEquals("""
                [-] --> staticReverse.map∩0:c.map.§kvs,\
                staticReverse.map.§vks[-2].§k∩0:c.map.§kvs,\
                staticReverse.map.§vks[-1].§v∩0:c.map.§kvs,\
